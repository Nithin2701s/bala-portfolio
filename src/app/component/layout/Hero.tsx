...
function Hero() {
    return (
        <div id="Hero" className="hero-section my-3 flex justify-center items-center p-4 h-screen bg-port text-white">
            <div className="hero-content md:w-1/2 text-center md:text-left ml-20">
