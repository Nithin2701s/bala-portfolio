...
const Projects = () => {
  return (
    <div id="projects" className="flex justify-center items-center p-4 bg-port text-white">
      <div className="project-cont flex flex-wrap justify-center gap-8 w-full overflow-auto max-h-[80vh] md:flex-nowrap md:overflow-x-scroll md:overflow-y-hidden">
        {[
          {
          ...
          <div key={index} className="bg-blue ml-[4rem] mr-[4rem] p-6 rounded-lg shadow-lg transform transition duration-500 hover:scale-105 hover:shadow-2xl w-72 h-70">
            <Image
